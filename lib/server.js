...
router.set('/api/targets', {
  POST: (req, res) => createTargetController(req, res),
  GET: (req, res) => getTargetsController(req, res)
})
router.set('/api/target/:id', {
  GET: (req, res, opts) => getTargetController(req, res, opts),
  POST: (req, res, opts) => updateTargetController(req, res, opts)
})
