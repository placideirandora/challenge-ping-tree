...
router.set('/api/targets', {
  POST: (req, res) => controllers.createTargetController(req, res),
  GET: (req, res) => controllers.getTargetsController(req, res)
})
router.set('/api/target/:id', {
  GET: (req, res, opts) => controllers.getTargetController(req, res, opts),
  POST: (req, res, opts) => controllers.updateTargetController(req, res, opts)
})
router.set('/route', { POST: (req, res) => controllers.makeDecisionController(req, res) })
